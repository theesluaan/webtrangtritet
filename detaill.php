...
<section class="detail">
    <div class="container">
        <div class="detail-top">
            ...
            <span>Thông tin đơn hàng của bạn sẽ được lưu giữ 1 giờ.</span>
        </div>
        <h1>Mã đơn hàng:<span
        ...
        <p style="text-align: center;">Mọi thắc mắc quý khách vui lòng liên hệ hotline <span
                style="font-size: 20px; color: red;">0378 902 874</span> hoặc chat với kênh hỗ trợ trên website để được hỗ
            trợ nhanh nhất.</p>
    </div>
</section>
