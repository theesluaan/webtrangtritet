    ...
    <div class="product-add-content">
        ...
        <form action="productadd.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="sanpham-size">
                <p>Nhỏ</p> <input type="checkbox" name="sanpham-size[]" value="Nhỏ">
                <p>Vừa</p> <input type="checkbox" name="sanpham-size[]" value="Vừa">
                <p>To</p> <input type="checkbox" name="sanpham-size[]" value="To">
                <p>Siêu To</p> <input type="checkbox" name="sanpham-size[]" value="Siêu to">
