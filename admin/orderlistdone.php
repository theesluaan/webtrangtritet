    ...
    <div class="table-content">
        ...
        <table>
            ...
            <tr>
                ...
                <td> <a href="orderdetail.php?order_ma=<?php echo $result['session_idA'] ?>" style="color:tomato">Xem</a></td>
                <td><a>Đã hoàn thành</a></td>
                <td><a style="color:tomato" href="?status=0&session_idA=<?php echo $result['session_idA'] ?>">Xác nhận chưa hoàn thành</a></td>
                
                <td><a href="orderdelete.php?session_idA=<?php echo $result['session_idA'] ?>"
                        onclick="return confirm('Đơn hàng sẽ bị xóa vĩnh viễn, bạn có chắc muốn tiếp tục không?');" style="color:tomato">Xóa</a>
                </td>
            </tr>
            <?php
                     }}
